...
#define HOST_IP "192.168.1.26"    //eqemu loginserver_ip is 66.55.145.2
...
public:
 ...
 //声明一个发出请求缓存
	...
	{
		0x00,0x03,0x04,0x00,0x15,0x00,0x00,0x20,0x00,0x09,0x00,0x01,0x02,0x00,
		0x03,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,
		0x52,0x2f,0x74,0xa9,0x7e,0xe3,0x3d,0xbc,0x3d,0xdb,0x00,0x96,0x36,0xf1,0xd3,0x98,0x24,0xf3
	};

	unsigned char send4[28]
	{
		//0x00,0x03,0x04,0x00,0x15,0x00,0x00,0x20,0x00,0x09,0x00,0x01,0x02,0x00,
		0x03,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,
		0x52,0x2f,0x74,0xa9,0x7e,0xe3,0x3d,0xbc,0x3d,0xdb,0x00,0x96,0x36,0xf1,0xd3,0x98,0x24,0xf3
	...
	unsigned char end1[18]
	{
		0x00,0x09,0x00,0x03,0x03,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xf9,0x98
	};

	unsigned char end2[10]
	{
...
private:
	...
	unsigned int cryptoidbuff(int acidbuf_id);
	
public:
	int edcrypt(uchar* buff, int size);
};
